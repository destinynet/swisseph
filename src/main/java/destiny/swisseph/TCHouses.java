...
public class TCHouses extends TransitCalculator implements Serializable {
  ...
  private int tflags; // The transit flags
  private int flags;  // The calculation flags for swe_calc()
  private double min;
  private double max;
  ...
  double minVal = 0.;
  double maxVal = 0.;  // Thinking about it...
   ...
   * @see destiny.swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double)
   * @see destiny.swisseph.TCPlanet#TCPlanet(SwissEph, int, int, double)
   * @see destiny.swisseph.SweConst#SEFLG_TRANSIT_LONGITUDE
   * @see destiny.swisseph.SweConst#SEFLG_SIDEREAL
   * @see destiny.swisseph.SweConst#SE_HOUSE1
   * @see destiny.swisseph.SweConst#SE_HOUSE2
   * @see destiny.swisseph.SweConst#SE_HOUSE3
   * @see destiny.swisseph.SweConst#SE_HOUSE4
   * @see destiny.swisseph.SweConst#SE_HOUSE5
   * @see destiny.swisseph.SweConst#SE_HOUSE6
   * @see destiny.swisseph.SweConst#SE_HOUSE7
   * @see destiny.swisseph.SweConst#SE_HOUSE8
   * @see destiny.swisseph.SweConst#SE_HOUSE9
   * @see destiny.swisseph.SweConst#SE_HOUSE10
   * @see destiny.swisseph.SweConst#SE_HOUSE11
   * @see destiny.swisseph.SweConst#SE_HOUSE12
   * @see destiny.swisseph.SweConst#SE_ASC
   * @see destiny.swisseph.SweConst#SE_MC
   * @see destiny.swisseph.SweConst#SE_ARMC
   * @see destiny.swisseph.SweConst#SE_VERTEX
   * @see destiny.swisseph.SweConst#SE_EQUASC
   * @see destiny.swisseph.SweConst#SE_COASC1
   * @see destiny.swisseph.SweConst#SE_COASC2
   * @see destiny.swisseph.SweConst#SE_POLASC
   * @see destiny.swisseph.SweConst#SE_HSYS_PLACIDUS
   * @see destiny.swisseph.SweConst#SE_HSYS_KOCH
   * @see destiny.swisseph.SweConst#SE_HSYS_PORPHYRIUS
   * @see destiny.swisseph.SweConst#SE_HSYS_REGIOMONTANUS
   * @see destiny.swisseph.SweConst#SE_HSYS_CAMPANUS
   * @see destiny.swisseph.SweConst#SE_HSYS_EQUAL
   * @see destiny.swisseph.SweConst#SE_HSYS_VEHLOW
   * @see destiny.swisseph.SweConst#SE_HSYS_MERIDIAN
   * @see destiny.swisseph.SweConst#SE_HSYS_HORIZONTAL
   * @see destiny.swisseph.SweConst#SE_HSYS_POLICH_PAGE
   * @see destiny.swisseph.SweConst#SE_HSYS_ALCABITIUS
   * //  * @see destiny.swisseph.SweConst#SE_HSYS_GAUQUELIN_SECTORS
   * @see destiny.swisseph.SweConst#SE_HSYS_MORINUS
   * @see destiny.swisseph.SweConst#SE_HSYS_KRUSINSKI
   * @see destiny.swisseph.SweConst#SE_HSYS_WHOLE_SIGN
   */
