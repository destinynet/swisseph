...
double minVal = 0., maxVal = 0.;  // Thinking about it...
  ...
  * in deg/day.
  * @see destiny.swisseph.TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double, int, double)
  * @see destiny.swisseph.TCPlanet#TCPlanet(SwissEph, int, int, double)
  * @see destiny.swisseph.TCPlanet#TCPlanet(SwissEph, int, int, double, int, double)
  * @see destiny.swisseph.SweConst#SEFLG_TRANSIT_LONGITUDE
  * @see destiny.swisseph.SweConst#SEFLG_TRANSIT_LATITUDE
  * @see destiny.swisseph.SweConst#SEFLG_TRANSIT_DISTANCE
  * @see destiny.swisseph.SweConst#SEFLG_TRANSIT_SPEED
  * @see destiny.swisseph.SweConst#SE_AST_OFFSET
  * @see destiny.swisseph.SweConst#SEFLG_PARTILE_TRANSIT
  * @see destiny.swisseph.SweConst#SEFLG_PARTILE_TRANSIT_START
  * @see destiny.swisseph.SweConst#SEFLG_PARTILE_TRANSIT_END
  * @see destiny.swisseph.SweConst#SEFLG_YOGA_TRANSIT
  * @see destiny.swisseph.SweConst#SEFLG_TOPOCTR
  * @see destiny.swisseph.SweConst#SEFLG_EQUATORIAL
