...
// swephexp.h: ///////////////////////////////////////////////////////////////
  ...
  public static final int SEFLG_DPSIDEPS_1980 = (256 * 1024); /* reproduce JPL Horizons 1962 - today to 0.002 arcsec. */
...
//  public static final int SIMULATE_VICTORVB           = 1;	// is a #define for SweHel
  ...
  public static final double SE_TIDAL_DE422 = (-25.85);   /* JPL Interoffice Memorandum 14-mar-2008 on DE421 (sic!) Lunar Orbit */
  ...
  public static final double SE_TIDAL_DE441 = (-25.936);  /* unpublished value, from email by Jon Giorgini to DK on 11 Apr 2021 */
...
// endif /* SE_EPHE_PATH */
   ...
   *
   * @see destiny.swisseph.SwissEph#swe_rise_trans(double, int, java.lang.StringBuffer, int, int, double[], double, double, destiny.swisseph.DblObj, java.lang.StringBuffer)
   */
   ...
   *
   * @see destiny.swisseph.SwissEph#swe_azalt(double, int, double[], double, double, double[], double[])
   */
   ...
   * long., xout[1]=&nbsp;ecl. lat..
   *
   * @see destiny.swisseph.SwissEph#swe_azalt_rev(double, int, double[], double[], double[])
   */
   ...
   *
   * @see destiny.swisseph.SwissEph#swe_refrac(double, double, double, int)
   * @see #SE_APP_TO_TRUE
   */
