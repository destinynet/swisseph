...
//////////////////////////////////////////////////////////////////////////////
   ...
   * parameter!
   * @see SwissEph#swe_calc(double, int, int, double[], StringBuffer)
   ...
   * @see #swe_fixstar(StringBuffer, double, int, double[], StringBuffer)
   */
...
// found in the method _calc().
   ...
   * @see #swe_calc_ut(double, int, int, double[], StringBuffer)
   * @see #swe_calc(double, int, int, double[], StringBuffer)
   */
...
// Hopefully, I did understand the whole thing correctly...
          if (s.charAt(0) == '?' || Character.isDigit(s.charAt(1))) {
            int ipli = ipl - SweConst.SE_AST_OFFSET;
            int iplf = 0;
            FilePtr fp = null;
            String si;
            try {
...
// NBT
  ...
  public double[] getDatafileTimerange(String fname) throws SwissephException {
    if (matches(".*\\Ws(e|[0-9])[0-9][0-9][0-9][0-9][0-9](s|).se1", fname)) {
      return new FileData().getDatafileTimerange(this, fname, swed.ephepath, true);
    } else if (matches("seas[_m][0-9]+.se1", fname) ||
        matches("semo[_m][0-9]+.se1", fname) ||
        matches("sepl[_m][0-9]+.se1", fname)) {
   ...
   * @see SwissEph#swe_nod_aps_ut(double, int, int, int, double[], double[], double[], double[], StringBuffer)
   * @see SweConst#OK
   * @see SweConst#ERR
   ...
   *               something fails.
   * @return SweConst.OK (0) or SweConst.ERR (-1)
   * @see SwissEph#swe_nod_aps(double, int, int, int, double[], double[], double[], double[], StringBuffer)
   * @see SweConst#OK
   * @see SweConst#ERR
   * @see SweConst#SE_NODBIT_MEAN
   * @see SweConst#SE_NODBIT_OSCU
   ...
   *              something fails.
   * @return SweConst.OK (0) or SweConst.ERR (-1)
   * @see SwissEph#swe_pheno_ut(double, int, int, double[], StringBuffer)
   * @see SweConst#OK
   * @see SweConst#ERR
   ...
   * SweConst.SE_ECL_ANNULAR | SweConst.SE_ECL_NONCENTRAL<br>
   * SweConst.SE_ECL_PARTIAL<br>
   * @see #swe_sol_eclipse_where(double, int, double[], double[], StringBuffer)
   * @see #swe_fixstar_ut(StringBuffer, double, int, double[], StringBuffer)
   * @see SweDate#setGlobalTidalAcc(double)
   */
   ...
   * SweConst.SE_ECL_CENTRAL<BR>
   * SweConst.SE_ECL_NONCENTRAL
   * @see #swe_sol_eclipse_when_glob(double, int, int, double[], int, StringBuffer)
   * @see #swe_fixstar_ut(StringBuffer, double, int, double[], StringBuffer)
   * @see SweConst#SE_ECL_ONE_TRY
   * @see SweConst#SE_ECL_TOTAL
   * @see SweConst#SE_ECL_ANNULAR
...
// throws IOException
   ...
   * (=UT&nbsp;+&nbsp;deltaT).<p>
   * See destiny.swisseph.TCPlanet or destiny.swisseph.TCPlanetPlanet below for examples on
...
//      moshier_planet:
   ...
   */
  int main_planet_bary(double tjd, int ipli, int epheflag, int iflag, boolean do_save,
...
////#endif /* TRACE0 */
  ...
  void swi_precess_speed(double[] xx, int xOffs, double t, int iflag, int direction) {
    Epsilon oe;
    double fac;
    double[] dpre = new double[1];
    double[] dpre2 = new double[1];
...
// TM - end of inclusion //////////////////////////////////////////////////////////
   ...
   * @see destiny.swisseph.SwissEph#getFixstarMagnitude(StringBuffer)
   */
   ...
   * @return magnitude of the star.
   * @see destiny.swisseph.SwissEph#getFixstarMagnitude(String)
   */
